...
export const ROUTES = [
  ...
  {
    path: '10',
    loadChildren: 'app/exercises/10/app.module#AppModule'
  },
  {
    path: '11',
    loadChildren: 'app/exercises/11/app.module#AppModule'
  },
  {
    path: '12',
    loadChildren: 'app/exercises/12/app.module#AppModule'
  },
  {
    path: '13',
    loadChildren: 'app/exercises/13/app.module#AppModule'
  },
  {
    path: '14',
  ...
  {
    path: '16',
    loadChildren: 'app/exercises/16/app.module#AppModule'
  },
  {
  ...
  {
    path: 'demo-data-flow',
    loadChildren: 'app/exercises/demo-data-flow/app.module#AppModule'
  }
];
